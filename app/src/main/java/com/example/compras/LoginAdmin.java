    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enviarnumero.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(phoneNumber)){
                    Toast.makeText(LoginAdmin.this,"INGRESE UN NÚMERO DE CELULAR.", Toast.LENGTH_SHORT).show();
                }else{
        ...
        enviarcodigo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(VerificacionCode)){
                    Toast.makeText(LoginAdmin.this,"INGRESE EL CODIGO RECIBIDO", Toast.LENGTH_SHORT).show();
                }else{
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                dialog.dismiss();
                Toast.makeText(LoginAdmin.this,"FALLO EL INICIO, Causas: \n1. Número invalido. \n2. Sin conexión a Internet.", Toast.LENGTH_LONG).show();
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken Token) {
                ...
                dialog.dismiss();
                Toast.makeText(LoginAdmin.this, "CODIGO ENVIADO SATISFACTORIAMENTE, Reciba tu bandeja de entrada.", Toast.LENGTH_LONG).show();
                numero.setVisibility(View.GONE);
                enviarnumero.setVisibility(View.GONE);
        ...
        auth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    dialog.dismiss();
                    Toast.makeText(LoginAdmin.this, "INGRESO CON EXITO.", Toast.LENGTH_LONG).show();
                    EnviaralaPrincipal();
                } else {
